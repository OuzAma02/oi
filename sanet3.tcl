# Configuration des options de noeud
...
# Type de file d'attente d'interface
set val(ifq) Queue/DropTail/PriQueue ;
# Type de couche de liaison
set val(ll) LL;
# Modèle d'antenne
set val(ant) Antenna/OmniAntenna ;
# Nombre maximal de paquets dans la file d'attente d'interface
set val(ifqlen) 50 ;
# Nombre de noeuds mobiles
set val(nn) 7 ;
# Protocole de routage
set val(rp) DSDV ;
# Dimension de la topologie
set val(x) 1000;
set val(y) 1000;
...
$ns at 0.0 "$node_(0) label Emetteur_a";
$ns at 0.0 "$node_(1) label Emetteur_b";
$ns at 0.0 "$node_(2) label Passerelle";
$ns at 0.0 "$node_(3) label Passerelle";
$ns at 0.0 "$node_(4) label Passerelle";
$ns at 0.0 "$node_(5) label Recepteur_a";
$ns at 0.0 "$node_(6) label Recepteur_b";
